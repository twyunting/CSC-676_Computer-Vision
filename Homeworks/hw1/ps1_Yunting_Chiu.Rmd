...
- The problem 4.1 (lines 51) is from Sobel operators.
- The problem 4.2 (lines 65) is from Laplacian operators.
...
- I ran 3D reconstruction code and found **img2.png** was fail to recover the 3D cube. According to Generic view assumption, we can see the green cube is stake on the red cube, 
